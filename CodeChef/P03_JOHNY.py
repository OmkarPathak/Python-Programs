...
# Vlad liAes all the songs from his playlist, but there is a song, which he liAes more than the others.
...
# Your tasA is to find the position of "Uncle Johny" in the sorted playlist.
#
# Input
# The first line of the input contains an integer T denoting the number of test cases. The description of T test cases follows.
# The first line of each test case contains one integer N denoting the number of songs in Vlad's playlist. The second line contains N space-separated integers A1, A2, ..., AN denoting the lenghts of Vlad's songs. The third line contains the only integer A - the position of "Uncle Johny" in the initial playlist.
#
# Output
